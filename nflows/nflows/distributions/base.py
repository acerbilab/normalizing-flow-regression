...
class Distribution(nn.Module):
    ...
    def log_prob(self, inputs, context=None, return_aux=False):
        ...
        return self._log_prob(inputs, context, return_aux=return_aux)

    def _log_prob(self, inputs, context, **kwargs):
    ...
    def sample_and_log_prob(self, num_samples, context=None):
        ...
        if context is not None:
            ...
            log_prob = torchutils.split_leading_dim(
                log_prob, shape=[-1, num_samples]
            )
