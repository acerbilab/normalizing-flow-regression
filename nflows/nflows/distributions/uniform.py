...
class LotkaVolterraOscillating:
    ...
    def log_prob(self, value):
        unnormalized_log_prob = self._gaussian.log_prob(
            value
        ) + self._uniform.log_prob(value)
    ...
    def sample(self, sample_shape=torch.Size()):
        ...
        while num_remaining_samples > 0:
            ...
            accepted_samples = candidate_samples[
                ~torch.isinf(uniform_log_prob)
            ]
